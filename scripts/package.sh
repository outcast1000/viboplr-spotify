#!/usr/bin/env bash
# Build spotify.zip (manifest.json at ROOT — required by install_plugin_from_zip)
...
FILE_URL="https://github.com/outcast1000/viboplr-spotify/releases/latest/download/spotify.zip"
...
rm -f spotify.zip
zip -q spotify.zip manifest.json index.js SPEC.md jsguide.md
...
echo
echo "To publish:"
echo "  gh release create v${VERSION} spotify.zip update.json --repo outcast1000/viboplr-spotify --title \"v${VERSION}\" --notes-file CHANGELOG.md"
